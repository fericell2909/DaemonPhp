...
class Database {
    ...
    public function getDb(){
        if (self::$pdo == null) {
            try {
	            $cadena = 'mysql:dbname=' . DATABASE .
		            ';host=' . HOSTNAME .
		            ';port:' . HOSTPORT . ';'.
                    USERNAME.
                    PASSWORD;
                self::$pdo = new PDO(
                    'mysql:dbname=erpuniversity;host=10.0.0.96;port:3306;',
	                "apiacces_demo",
	                "Test#_Ul4d3ch!",
                ...
                echo json_encode(array('error'=>'No se puede conectar con el servidor : ' . $e->getMessage()));
                exit;
            }
        }
        return self::$pdo;
