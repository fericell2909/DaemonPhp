	...
	foreach($data as $value){
		...
		if ($value['tipocorreoenvio'] == '1' && $value['pagocompromiso'] == '0')
		{
			...
			*/
			...
			$resultado_envio_correo = $email_v2->SendMail('01','022','DAEMON','',$value['asuntocorreo'],$value['correo'],@$value['correocopiaauditoria'],'','text/html' , $value['cuerpocorreo'] ,'',$bResultadoEnvio , $codigorespuesta , $mensajerespuesta);
