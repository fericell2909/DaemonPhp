...
include_once ('/var/www/CONEXIONES/PROD/database.php');
...
class General extends Database
{
	...
	function actualizar_envio_correo($postulante , $indiceregistro , $usuario,$codigorespuesta , $mensajerespuesta)
	{
		$data = array();
		$query  = "call sp_admision_registrar_preinscripcion_postulante('4','$postulante',$indiceregistro,'$mensajerespuesta','$codigorespuesta','','','',NULL,'0','0','','','','','','','','','','','','','','','','','','','','','','','','','','$usuario');";
		// echo $query; exit;
